...
<li id="menu-item-17" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-17"><a href="http://suncitynhatrang.vn/loai-phong">Tin tức</a></li>
...
<input type="hidden" name="_wpcf7_nonce" value="77bff65b5d" />
</div>
<ul class="cha">
<li>Tên: <span class="wpcf7-form-control-wrap ho-ten"><input type="text" required name="namekh" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Họ và tên" /></span> </li>
<li>Điện thoại: <span class="wpcf7-form-control-wrap dien-thoai"><input type="tel" required name="sdt" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-tel" aria-invalid="false" placeholder="Điện thoại" /></span></li>
<li>Email: <span class="wpcf7-form-control-wrap email"><input type="email" required name="email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Địa chỉ Email của bạn" /></span> </li>
<li>Ngày:
<ul class="con book">
<input type="text" name="datefilter1" placeholder="Ngày" required class="input-date" autocomplete="off" />

                    <!-- <button type="submit" class="btn-search"><i class="text-white fs-6 fas fa-search"></i></button> -->
<!-- <li><span class="wpcf7-form-control-wrap ngayden"><input type="text" name="ngayden" value="" size="40" class="wpcf7-form-control wpcf7-date" id="ngayden" placeholder="Ngày đến" /> </span></li>
<li><span class="wpcf7-form-control-wrap ngaydi"><input type="text" name="ngaydi" value="" size="40" class="wpcf7-form-control wpcf7-date" id="ngaydi" placeholder="Ngày đi" /> </span></li> -->
</ul>
<script type="text/javascript" src="./ngay.js"></script>
</li>
<!-- <li>Loại phòng: <span class="wpcf7-form-control-wrap loaiphong"><select name="loaiphong" class="wpcf7-form-control wpcf7-select" id="loaiphong" aria-invalid="false"><option value="Phòng STANDARD">Phòng STANDARD</option><option value="Phòng SUPERIOR">Phòng SUPERIOR</option><option value="Phòng DELUXE">Phòng DELUXE</option><option value="Phòng SUITE">Phòng SUITE</option></select></span></li> -->
<li>Số người:
<ul class="con">
<li><span class="wpcf7-form-control-wrap nguoilon"><input type="number" required name="nguoilon" value="" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number" id="nguoilon" min="0" aria-invalid="false" placeholder="Người lớn" /></span></li>
<li><span class="wpcf7-form-control-wrap treem"><input type="number" required name="treem" value="" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number" id="treem" min="0" aria-invalid="false" placeholder="Trẻ em" /></span></li>
</ul>
</li>
<button style = "margin-left: 415px; margin-top: 30px;" type="submit" name ="btnOK" class="btn btn-primary">Đặt ngay</button>
</ul>
...
<?php
    ...
    if(isset($_POST['btnOK'])){
        $row_giakm = mysqli_query($connect, "SELECT giakm FROM luachon WHERE idluachon=$idlc");
        $row_giakm = $row_giakm->fetch_assoc();
        $giakm = $row_giakm['giakm'];
        $date = $_POST["datefilter1"];
        ...
        $tonggia = floor($datediff / (60*60*24)) * $giakm;
        mysqli_query($connect, "INSERT INTO booking VALUES (null, $idroom, $idlc, '$namekh', '$sdt', '$email', '$check_in', '$check_out', '$nguoilon', '$treem', '$tonggia')");
        echo '<script>confirm("đặt phòng thành công")</script>';
    }
?>
        <?php     
            // $to_email = 'lythilananh240699@gmai.com';
